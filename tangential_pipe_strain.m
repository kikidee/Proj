% Function to calculate tangential surface strain from a
...
plot(top_depth, abs(norm_tang_strain), 'LineWidth', 2)
...
title('Tangential Pipe Strain (Lisowski)', 'FontSize', 12, 'FontName', 'Arial');

% Set Axis
xlabel('Distance (Top Depths)', 'FontSize', 12, 'FontName', 'Arial')
ylabel('Tangential Strain (strain units)', 'FontSize', 12)
...
% images are 2000
print(1,'-djpeg','lisowski_pipe_tangential','-r500')
